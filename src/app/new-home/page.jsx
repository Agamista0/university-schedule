  ...
  const categories = [
    {
      ...
      description: 'Upload technical documents, software licenses, and project specifications securely for IT operations.',
      icon: Cloud,
      color: 'text-blue-500'
    },
    {
      ...
      description: 'Submit administrative reports, financial records, and operational guidelines for review.',
      icon: Building,
    ...
    },
    {
      ...
      description: 'Contribute academic papers, research data, and course materials for various departments.',
      icon: GraduationCap,
    ...
    },
    {
      ...
      description: 'Upload HR policies, employee records, and training manuals while maintaining confidentiality.',
      icon: Users,
      color: 'text-gray-600'
    }
  ];
      ...
      <div className="ml-64">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 max-w-2xl">
            Select a category below to upload files relevant to your content management needs. Each 
            category provides a dedicated and secure space for your documents.
          </p>
        </div>
